...
.apply-option input,.apply-consent input{width:16px;height:16px;padding:0;flex:0 0 16px}
    ...
    return (
      <div className="apply-page">
        ...
        <main className="apply-success">
          ...
          <p>Your application has been submitted to the SSP team. If your qualifications match an upcoming assignment, a representative will contact you using the information you provided.</p>
